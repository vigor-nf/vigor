...
# - NF_IS_SELF_CONTAINED := <if this is true, ignore the rest of this file and look at Makefile.selfcontained>
...
ifeq (true,$(NF_IS_SELF_CONTAINED))
# Self-contained NFs
include $(SELF_DIR)/Makefile.selfcontained
else ifeq (click,$(findstring click,$(shell pwd)))
# Click baselines
