 ...
 * files, etc. If NULL, object is called "unnamed".
 */
static inline int klee_range(int begin, int end, const char *name) {
  assert(0);
}
 ...
 * test file.
 */
__attribute__((noreturn)) static inline void klee_silent_exit(int status) {
  exit(status);
}
...
klee_report_error(const char *file, int line, const char *message,
                  const char *suffix) {
  assert(0);
}
...
/* klee_alias_function("foo", "bar") will replace, at runtime (on
   ...
   may not always work. */
static inline void klee_alias_function(const char *fn_name,
...
static inline void klee_alias_function_regex(const char *fn_regex,
                                             const char *new_fn_name) {}
...
static inline void klee_trace_param_ptr(void *ptr, int width,
                                        const char *name) {}
...
static inline void klee_trace_param_tagged_ptr(void *ptr, int width,
                                               ...
                                               const char *type,
                                               TracingDirection td) {}
static inline void klee_trace_param_just_ptr(void *ptr, int width,
                                             const char *name) {}
...
static inline void klee_trace_param_ptr_field(void *ptr, int offset, int width,
                                              const char *name) {}
...
static inline void klee_trace_param_ptr_field_just_ptr(void *ptr, int offset,
                                                       int width,
                                                       const char *name) {}
static inline void klee_trace_ret_ptr_field(int offset, int width,
                                            const char *name) {}
static inline void klee_trace_ret_ptr_field_just_ptr(int offset, int width,
                                                     const char *name) {}
static inline void klee_trace_param_ptr_nested_field(void *ptr, int base_offset,
                                                     int offset, int width,
                                                     const char *name) {}
static inline void klee_trace_param_ptr_nested_field_directed(
    void *ptr, int base_offset, int offset, int width, const char *name,
    TracingDirection td) {}
static inline void klee_trace_param_ptr_nested_field_arr_directed(
    void *ptr, int base_offset, int offset, int el_width, int count, char *name,
    TracingDirection td) {}
static inline void klee_trace_ret_ptr_nested_field(int base_offset, int offset,
                                                   int width,
                                                   const char *name) {}
static inline void klee_trace_extra_ptr(void *ptr, int width, const char *name,
                                        const char *type, TracingDirection td) {
}
static inline void klee_trace_extra_ptr_field(void *ptr, int offset, int width,
                                              const char *name,
                                              TracingDirection td) {}
...
static inline void klee_trace_extra_ptr_nested_field(void *ptr, int base_offset,
                                                     ...
                                                     TracingDirection td) {}
static inline void
klee_trace_extra_ptr_nested_field_arr(void *ptr, int base_offset, int offset,
                                      int el_width, int count, const char *name,
                                      TracingDirection td) {}
static inline void klee_trace_extra_ptr_nested_nested_field(
    void *ptr, int base_base_offset, int base_offset, int offset, int width,
