...
#undef KLEE_TRACE_PARAM_PROTO
  ...
  static inline void klee_trace_param_ptr_nested_field_directed(void* ptr, int base_offset,
                                                  int offset, int width, const char* name,
                                                  TracingDirection td) {}
  static inline void klee_trace_param_ptr_nested_field_arr_directed(void* ptr, int base_offset,
                                                      int offset, int el_width,
                                                      int count, char* name,
                                                      TracingDirection td) {}
  ...
  static inline void klee_trace_extra_ptr_nested_field_arr(void* ptr, int base_offset,
                                             int offset, int el_width, int count,
