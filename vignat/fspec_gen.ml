...
let gen_records = ref []
let () = 
  gen_records := ("FlowId", (Ir.Str ("FlowId", ["src_port", Ir.Uint16; "dst_port", Ir.Uint16; "src_ip", Ir.Uint32; "dst_ip", Ir.Uint32; "internal_device", Ir.Uint16; "protocol", Ir.Uint8])))::!gen_records
